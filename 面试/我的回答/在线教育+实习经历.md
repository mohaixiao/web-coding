...
面试官您好，我叫xxx，是成都信息工程大学软件工程大三的学生。今天来应聘贵公司的前端开发实习生的岗位。

我在大二上的时候开始接触到前端，并对前端产生了浓厚的兴趣，我的技术栈是react，我在知乎和绿盟科技的实习过一段时间。

在知乎分别主要负责对公的员工管理项目和面向运营开发的反作弊分析项目，

在实习中我认识到了合理封装组件的好处，

以及性能优化和规范的工作流程的重要性。

在绿盟科技，我负责老项目的迭代开发新功能，我学到了使用微前端进行老项目的维护和新项目的开发。

同时我自己也开发了一个包括前台和后台的在线课程项目，这个项目比较好的亮点的话是

在登录方面我做了微信三方登录，短信校验，微信支付，

在性能方面我做过SEO优化，图片压缩优化等一系列操作，

在用户体验上，我也尝试做了一个弹幕功能，

数据收集上我也尝试了用户的访问量和点击量、地域、来源的收集。

后台我就做了一个视频断点续传，以及一个大屏可视化，同时我也封装了一个统一的表格组件和搜索组件。

在我也喜爱写博客文章，分享技术。我个人性格比较开朗，外向。
